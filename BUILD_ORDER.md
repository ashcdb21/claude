...
| 1 | Pitch renderer (metre→pixel transform, markings, portrait rotation, ResizeObserver) | `index.html` | |
| 2 | 22 players + ball, Move tool, 4-3-3 vs 4-4-2, carrier within 2.6 m | `index.html` | |
